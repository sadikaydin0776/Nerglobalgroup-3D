        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col gap-6">
            ...
            <a
              ...
              className="flex items-center gap-3 px-7 h-[52px] w-fit bg-[#25D366]/10 text-[#25D366] border border-[#25D366]/20 rounded-full font-semibold hover:bg-[#25D366]/20 transition-all duration-300 hover:scale-[1.02]"
            >
