  ...
  return (
    <section id="iletisim" className="relative w-full py-28 lg:py-36 bg-surface overflow-hidden">
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-16 relative z-10">
        ...
        {/* Google Maps */}
        <div className="mt-12 rounded-[24px] overflow-hidden border border-white/[0.06] relative" style={{ height: '300px' }}>
          <iframe
            src="https://maps.google.com/maps?q=Concepta+Plaza+Esenyurt+Istanbul&output=embed&z=15"
            width="100%"
            height="100%"
            style={{ border: 0, filter: 'invert(88%) hue-rotate(180deg) brightness(0.82) contrast(0.88) saturate(0.9)' }}
            allowFullScreen={false}
            loading="lazy"
            referrerPolicy="no-referrer-when-downgrade"
            title="NEW GLOBAL GROUP Ofis Konumu — Esenyurt, İstanbul"
          />
        </div>
      </div>
    </section>
